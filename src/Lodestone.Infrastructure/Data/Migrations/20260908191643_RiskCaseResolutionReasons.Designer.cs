...
namespace Lodestone.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260908191643_RiskCaseResolutionReasons")]
    partial class RiskCaseResolutionReasons
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lodestone.Domain.Entities.SupportInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("EscalatedToCounselor")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("VolunteerUserId", "Type");

                    b.ToTable("SupportInteractions");
                });

            modelBuilder.Entity("Lodestone.Domain.Entities.SupportRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Status", "IsVisibleToVolunteers", "CreatedAtUtc");

                    b.HasIndex("VolunteerProfileId", "Status", "CreatedAtUtc");

                    b.ToTable("SupportRequests");
                });

            modelBuilder.Entity("Lodestone.Domain.Entities.VolunteerAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VolunteerProfileId", "IsActive");

                    b.HasIndex("VolunteerProfileId", "StudentProfileId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Lodestone.Domain.Entities.SupportInteraction", b =>
                {
                    b.HasOne("Lodestone.Domain.Entities.SupportRequest", "SupportRequest")
            ...
            modelBuilder.Entity("Lodestone.Domain.Entities.SupportRequest", b =>
                {
                    ...
                    b.HasOne("Lodestone.Domain.Entities.VolunteerProfile", "VolunteerProfile")
                        .WithMany("SupportRequests")
